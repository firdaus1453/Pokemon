...
import com.example.pokemon.core.presentation.ui.textAsFlow
...
import com.example.pokemon.core.presentation.ui.asUiText
...
class LoginViewModel(
    ...
    private fun login() {
        viewModelScope.launch {
            ...
            when(result) {
                is com.example.pokemon.core.domain.util.Result.Error -> {
